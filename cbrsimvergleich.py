...
vglarray = np.zeros(50)
vglarraysp = np.zeros(50)
...
LAYOUT = [[
    pg.Column([[
        ...
        pg.Column([
            ...
            [pg.Input(0.9812, size=(4, 1), key="-Radiussuche-")],
...
def main():
    ...
    while True:
        ...
        if event == '-Berechnen-':
            ...
            durchgang = 0
            while durchgang < 50:
                normedinput = (eingabezerlegt1[[durchgang]] - minimum) / range * SENSITIVITY
                ...
                if durchgang == 50:
                    print(vglarray)
                    print(vglarraysp)
                    vglarray1 = np.reshape(vglarray, (50, 1)) 
                    vglarraysp1 = np.reshape(vglarraysp, (50, 1)) 

                    ## convert your array into a dataframe
                    df = pd.DataFrame (vglarray1)
                    ef = pd.DataFrame (vglarraysp1)

                    ## save to xlsx file
                    filepath = 'vgl5verf.xlsx'
